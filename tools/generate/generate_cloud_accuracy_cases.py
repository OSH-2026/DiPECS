...
def main() -> None:
    ...
    parser.add_argument("--seed-cases", default="data/evaluation/cloud-llm-accuracy-cases.json")
    parser.add_argument("--output", default="data/evaluation/cloud-llm-accuracy-cases.generated.json")
